<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SampleChat.Home" ValidateRequest="false"%>
            ...
            <asp:UpdatePanel ID="UpdatePanelMessages" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    ...
                    <asp:ListView ID="ListViewMessages" runat="server" DataKeyNames="Id"
                        SelectMethod="ListViewMessages_GetData" ItemType="SampleChat.Message">
