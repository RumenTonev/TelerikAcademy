<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModeratorDefault.aspx.cs" Inherits="ChatApp.Moderator.ModeratorDefault" %>
        ...
        <legend>Messages<br />
            ...
            <asp:GridView ID="GridViewMessages" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <FooterTemplate>
                            <asp:LinkButton runat="server" ID="GoChat"   OnClick="GoChat_Click"  Text="GoToChat"></asp:LinkButton>
                        </FooterTemplate>
                    </asp:TemplateField>
